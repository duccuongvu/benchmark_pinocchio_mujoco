...
DAMPING, STIFFNESS = 0.5, 0.5       # damping and stiffness coefficients
...
def dynamics(q, v, tau):
    ...
    vdot = np.linalg.solve(M, tau - b - DAMPING * v - STIFFNESS * q)   # M*vdot + b + damping*v + stiffness*(q - q_eq) = tau
    return v, vdot
